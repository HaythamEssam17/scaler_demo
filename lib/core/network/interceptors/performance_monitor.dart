...
// import 'package:scalers_demo/core/constants/enums/exception_enums.dart';
// import 'package:scalers_demo/core/helpers/shared.dart';
// import 'package:scalers_demo/core/presentation/widgets/Alert_Dialogs/custom_flutter_toast.dart';
...
//     try {
//       /// stop the HttpMetric
//       final span = response.requestOptions.extra['performanceSpan'] as HttpMetric;
...
//       span.stop().then((value) => devLog('===>>> span.. stop() onError then ===>>>'));
...
//     devLog('===>>> Request to ${response.requestOptions.uri} took $duration ms ===>>>');
...
//     devLog('===>>> Request to ${err.requestOptions.uri} failed after $duration ms ===>>>');
